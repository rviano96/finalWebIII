...
public class JWTAuth implements Serializable {
    ...
    public JWTAuth(int validitySeconds, String username, int version) {
    ...
    public String getVersionFromToken(String token) {
        Claims claims = getAllClaimsFromToken(token);
        return claims.get("version").toString();
    }
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        ...
        claims.put("version", this.version);
    ...
    public Boolean validateToken(String token, Usuario u) {
        ...
        return (username.equals(u.getUsername()) && !isTokenExpired(token) && u.getVersion()==Integer.parseInt(getVersionFromToken(token)));
    }
}
